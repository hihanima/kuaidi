...
public class SynQueryDemo {
    ...
    public static void main(String[] args) {
        String key = "ekEmPyJP4083";				//贵司的授权key
        String customer = "CABB9B117E1AFDC97EC9CEE0EFE4FF11";			//贵司的查询公司编号
        String com = "yunda";			//快递公司编码
        String num = "3878810175506";	//快递单号
        String phone = "";				//手机号码后四位
        String from = "";				//出发地
        String to = "";					//目的地
        int resultv2 = 0;				//开启行政规划解析,0：关闭（默认），1：开通
